...
class CustomNavBar extends StatefulWidget {
  ...
  CustomNavBar({required this.context, required this.onItemTapped, required this.selectedIndex});
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 2:
        ...
        break;
      case 3:
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ChefOrder()));
        break;
      case 4:
        ...
        body: Column(
          children: [
            Row(
              children: [
                Padding(
                  padding: EdgeInsets.only(left: _screenwidth * 0.05, top: _screenheight * 0.015),
                  child: AppLiteText(
                    text: 'Overview',
            ...
            Row(children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: _screenwidth * 0.02, top: _screenheight * 0.02, right: _screenwidth * 0.02), // 2% of screen width and height
                child: Container(
                  width: _screenwidth * 0.44, // 45% of screen width
                  height: _screenheight * 0.16, // 16% of screen height
                  decoration: BoxDecoration(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(40), // Half of the width or height of the image for circular shape
                        ),
            ...
            Row(
              children: [
                Padding(
                  padding: EdgeInsets.only(left: _screenwidth * 0.05, right: _screenwidth * 0.05), // 2% of screen width
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Icon(Icons.attach_money,size: 30, color: Color.fromRGBO(255, 106, 66, 1),),
                        ), // Dollar icon
                        Padding(
                          padding:  EdgeInsets.only(left: _screenwidth * 0.05),
                          child: AppLiteText(
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: _screenwidth * 0.25), // 12% of screen width
                          child: RichText(
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text: 'Rs. ',
                                  style: TextStyle(fontSize: _screenwidth * 0.040,color: Color.fromRGBO(255, 106, 66, 1),fontWeight: FontWeight.w500),
                                ),
                                TextSpan(
                                  text: '2500',
                                  style: TextStyle(fontSize: _screenwidth * 0.040,color: AppColors.textColor,fontWeight: FontWeight.w500),
                                ),
                              ],
                            ),
                          ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.only(left:_screenwidth*0.05 ),
                          child: Icon(Icons.bar_chart_rounded,size: 30, color: Color.fromRGBO(160, 212, 104, 1),),
                        ), // Dollar icon
                        Padding(
                          padding: EdgeInsets.only(left:_screenwidth*0.05 ),
                          child: AppLiteText(
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: _screenwidth * 0.115), // 6.8% of screen width
                          child: AppLiteText(
                            text: '90%',
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.only(left: _screenwidth*0.05),
                          child: Image(
                            image: AssetImage('assets/imgs/chefcap.png'), // Replace with your image path
                            width: _screenwidth * 0.075, // 7.5% of screen width
                            height: _screenheight * 0.075, // 7.5% of screen height
                            color: Color.fromRGBO(255, 106, 66, 1), // Apply color tint if desired
                          ),
                        ...
                        Padding(
                          ...
                          child: Image(
                            image: AssetImage('assets/imgs/crown.png'), // Replace with your image path
            ...
            Expanded(
              child: ListView.separated(
                ...
                separatorBuilder: (context, index) => Divider(color: Colors.grey), // Use a divider instead of SizedBox
                itemBuilder: (context, index) {
                  return Padding(
                    padding: EdgeInsets.symmetric(horizontal: _screenwidth * 0.02), // 2% of screen width
                    child: Card( // Use Card for a better UI
                      elevation: 5, // Shadow
                          ...
                          title: Row(
                            children: [
                              Text(
                                ...
                                style: TextStyle(fontWeight: FontWeight.w500, fontSize: _screenwidth * 0.04, fontFamily: "Poppins"), // 4% of screen width
                              ),
                              Spacer(),
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: Color.fromRGBO(255, 106, 66, 0.12),
                                  borderRadius: BorderRadius.circular(_screenwidth * 0.05), // 5% of screen width
                                ),
                                child: Icon(
                                  Icons.watch_later_outlined,
                                  size: _screenwidth * 0.0625, // 6.25% of screen width
                                  color: Color.fromRGBO(255, 106, 66, 1),
                                ),
                              ),
                            ],
