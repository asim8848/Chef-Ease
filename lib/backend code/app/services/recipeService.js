...
const getRecipesByChefId = async (chefId) => {
  return await Recipe.find({ ChefFirebaseID: chefId });
};
...
const getRecipeByRecipeId = async (recipeId) => {
  return await Recipe.findOne({ RecipeID: recipeId });
};
...
module.exports = {
  ...
  getRecipeByRecipeId, // Added this line
  updateRecipe,
  deleteRecipe
};
